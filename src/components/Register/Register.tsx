...
export const Register = () => {
    ...
    const sendForm = async (e: FormEvent) => {
        ...
        if (registerData.username.trim().length < 3 || registerData.username.trim().length > 55) {
            setError('User name cannot be shorter than 3 characters and later than 55 characters');
            return;
        }
        ...
        if (registerData.password.trim().length < 7 || registerData.password.trim().length > 60) {
            setError('Password cannot be shorter than 7 characters and later than 60 characters');
            return;
        }
