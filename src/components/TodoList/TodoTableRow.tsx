  ...
  updateTaskStatus();
    ...
    return (
        <>
            ...
            {loading && <Spinner/>}
            <tr className='line'>
                <FontAwesomeIcon className='check' style={{color: isComplete ? 'green' : ''}} icon={faCircleCheck} onClick={onCheckTask}/>
                ...
                </td> : <td className='title' style={isComplete ? {
                    backgroundColor: 'green',
                    textDecoration: 'line-through'
                } : undefined}>{description}<FontAwesomeIcon className='pen' style={{pointerEvents: isComplete ? 'none' : undefined }} icon={faPen} onClick={()=> setIsEditing(true)}/>
